  ...
  switch (unitInput) {
    case "celsius":
      ...
      document.getElementById("result").innerHTML = `
                <p>${tempInput.toFixed(
                  2
                )}°C is equal to ${result.fahrenheit.toFixed(2)}°F</p>
                <p>${tempInput.toFixed(
                  2
                )}°C is equal to ${result.kelvin.toFixed(2)}K</p>
            `;
      break;
    case "fahrenheit":
      result = {
      ...
      document.getElementById("result").innerHTML = `
                <p>${tempInput.toFixed(
                  2
                )}°F is equal to ${result.celsius.toFixed(2)}°C</p>
                <p>${tempInput.toFixed(
                  2
                )}°F is equal to ${result.kelvin.toFixed(2)}K</p>
            `;
      break;
    case "kelvin":
      result = {
      ...
      document.getElementById("result").innerHTML = `
                <p>${tempInput.toFixed(
                  2
                )}K is equal to ${result.celsius.toFixed(2)}°C</p>
                <p>${tempInput.toFixed(
                  2
                )}K is equal to ${result.fahrenheit.toFixed(2)}°F</p>
            `;
      break;
    default:
      document.getElementById("result").innerHTML =
